...
{
    return [HNBUtils sandBoxGetInfo:[NSArray class] forKey:search_history];
}
//设置缓存搜索的数组
-(void)setSearchHistoryText :(NSString *)seaTxt
{
    ...
    //读取数组NSArray类型的数据
    NSArray *myArray = [HNBUtils sandBoxGetInfo:[NSArray class] forKey:search_history];
    ...
    [HNBUtils sandBoxSaveInfo:searTXT forKey:search_history];
...
-(void)removeAllArray
{
    [HNBUtils sandBoxClearAllInfo:search_history];
}
@end
