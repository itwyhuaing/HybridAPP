...
#import "IMHundredConsultCell.h"
#import "HomeQA.h"
#import "HomeQASpecial.h"
#import "HotPoint+CoreDataClass.h"

@implementation IMHundredConsultCell
...
- (void)awakeFromNib {
    ...
    self.firstButton.tag = IMHundredConsult_FirstBtn_Tag;
    self.secondButton.tag = IMHundredConsult_SecondBtn_Tag;
    self.thirdButton.tag = IMHundredConsult_ThirdBtn_Tag;
    self.fourthButton.tag = IMHundredConsult_FourthBtn_Tag;
