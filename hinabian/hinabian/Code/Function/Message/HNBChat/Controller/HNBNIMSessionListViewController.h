//
//  HNBNIMSessionListViewController.h
//  hinabian
//
...
@interface HNBNIMSessionListViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,NIMLoginManagerDelegate,NIMConversationManagerDelegate>
/**
 *  会话列表tableView
 */
 ...
 *  最近会话集合
 */
@property (nonatomic,strong) NSMutableArray * recentSessions;//（原本为readonly，现在需要在子类登录返回后刷新获取最近会话）
