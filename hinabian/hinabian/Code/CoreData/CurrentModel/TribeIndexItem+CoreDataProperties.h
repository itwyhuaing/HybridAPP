//
//  TribeIndexItem+CoreDataProperties.h
//  hinabian
//
...
@interface TribeIndexItem (CoreDataProperties)
...
/*精华*/
@property (nullable, nonatomic, retain) NSString *essence;
