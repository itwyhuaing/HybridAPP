...
//    UIImage *backspaceImage = [self.class _keyboardImageNamed:@"MMNumberKeyboardDeleteKey"];
//    UIImage *dismissImage = [self.class _keyboardImageNamed:@"MMNumberKeyboardDismissKey"];
    UIImage *backspaceImage = [UIImage imageNamed:@"MMNumberKeyboardDeleteKey"];
    UIImage *dismissImage = [UIImage imageNamed:@"MMNumberKeyboardDismissKey"];
