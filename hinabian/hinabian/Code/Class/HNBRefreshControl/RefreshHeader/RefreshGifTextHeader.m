...
@interface RefreshGifTextHeader ()
...
@implementation RefreshGifTextHeader
...
//        self.gifImageV.backgroundColor = [UIColor purpleColor];
...
- (void)placeSubviews
{
    ...
    rect.origin.x = SCREEN_WIDTH / 3.0 - rect.size.width;
    rect.origin.y = (self.mj_h - rect.size.height) / 2.0;
...
- (void)setState:(MJRefreshState)state
{
    ...
    switch (state) {
        ...
        case MJRefreshStateWillRefresh:
            NSLog(@" header MJRefreshStateWillRefresh -");
            self.msgLabel.text = @"即将刷新";
            break;
        case MJRefreshStateNoMoreData:
            NSLog(@" header MJRefreshStateNoMoreData - ");
