...
+ (void)initialize {
    _dataCache = [YYCache cacheWithName:kHNBNetDataCacheResponse];
}

+ (instancetype)defaultManager{
    static HNBFileManager *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[HNBFileManager alloc] init];
    });
    return instance;
}

#pragma mark ------ YYCache 高性能数据存储
