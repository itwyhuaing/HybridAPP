...
+ (UIColor *)DDBottomTabTextSelectedColorWithAlph:(CGFloat)alph{
    //return [UIColor colorWithRed:251.0f/255.0f green:51.f/255.0f blue:27.0f/255.0f alpha:alph]; APP 3.1 - 2018/1/15年春节版
    return [UIColor colorWithRed:63.0f/255.0f green:162.0f/255.0f blue:255.0f/255.0f alpha:alph];
}
